...
@section('content')
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="row mb-5">
                ...
                <div class="col-md-6 col-lg-4 mb-3">
                  <div class="card h-100">
                    ...
                    <img class="img-fluid" src={{ asset ("sneat/assets/img/elements/13.jpg")}} alt="Card image cap" />
                    <div class="card-body">
                  ...
                  <div class="card h-100">
                    <div class="card-body">
                      ...
                      <img
                        ...
                        src={{ asset ("sneat/assets/img/elements/4.jpg")}}
                        alt="Card image cap"
                      />
                      <p class="card-text">Bear claw sesame snaps gummies chocolate.</p>
                      <a href="javascript:void(0);" class="card-link">Card link</a>
              ...
              <div class="row mb-5">
                ...
                <div class="col-md-6 col-lg-4">
                  ...
                  <div class="card mb-4">
                    <img class="card-img-top" src={{ asset ("sneat/assets/img/elements/5.jpg")}} alt="Card image cap" />
                    <div class="card-body">
                      <p class="card-text">
                        Some quick example text to build on the card title and make up the bulk of the card's content.
                      </p>
                ...
                <div class="col-md-6 col-lg-4">
                  ...
                  <div class="card">
                    <img class="card-img-top" src={{ asset ("sneat/assets/img/elements/7.jpg")}} alt="Card image cap" />
                    <div class="card-body">
                      <h5 class="card-title">Card title</h5>
              ...
              <div class="row mb-5">
                ...
                <div class="col-md-6 col-xl-4">
                  <div class="card mb-3">
                    ...
                    <img class="card-img-bottom" src={{ asset ("sneat/assets/img/elements/1.jpg")}} alt="Card image cap" />
                  </div>
                </div>
                <div class="col-md-6 col-xl-4">
                  <div class="card bg-dark border-0 text-white">
                    <img class="card-img" src={{ asset ("sneat/assets/img/elements/11.jpg")}} alt="Card image" />
                ...
                <div class="col-md">
                  <div class="card mb-3">
                    <div class="row g-0">
                      ...
                      <div class="col-md-4">
                        <img class="card-img card-img-right" src={{ asset ("sneat/assets/img/elements/17.jpg")}} alt="Card image" />
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="card-group mb-5">
                ...
                <div class="card">
                  <img class="card-img-top" src={{ asset ("sneat/assets/img/elements/1.jpg")}} alt="Card image cap" />
                  <div class="card-body">
                    <h5 class="card-title">Card title</h5>
                    <p class="card-text">
                      This is a wider card with supporting text below as a natural lead-in to additional content. This
        ...
        {{-- script page --}}
        <!-- Vendors JS -->
      <script src={{ asset ("sneat/assets/vendor/libs/masonry/masonry.js")}}></script>
